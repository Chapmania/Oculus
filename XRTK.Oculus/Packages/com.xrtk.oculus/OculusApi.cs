...
/*
        ...
        */
        ...
        private static OVRInput.Controller[] controllers;

        internal static OVRInput.Controller[] Controllers
        {
            get
            {
                if (controllers == null)
                {
                    controllers = new OVRInput.Controller[]
                    {
        ...
        /*
                ...
                */
        internal static OVRInput.Controller activeControllerType = OVRInput.Controller.None;
        internal static OVRInput.Controller connectedControllerTypes = OVRInput.Controller.None;
        /*
        /// <summary>
        ...
        */
        ...
        internal static bool ShouldResolveController(OVRInput.Controller controllerType, OVRInput.Controller controllerMask)
        {
            bool isValid = false;
            ...
            // If the mask requests both Touch controllers, reject the individual touch controllers.
            if (((controllerMask & OVRInput.Controller.Touch) == OVRInput.Controller.Touch)
                && ((controllerType & OVRInput.Controller.Touch) != 0)
                && ((controllerType & OVRInput.Controller.Touch) != OVRInput.Controller.Touch))
            {
                isValid = false;
            }

            // If the mask requests both hand controllers, reject the individual hand controllers.
            if (((controllerMask & OVRInput.Controller.Hands) == OVRInput.Controller.Hands)
                && ((controllerType & OVRInput.Controller.Hands) != 0)
                && ((controllerType & OVRInput.Controller.Hands) != OVRInput.Controller.Hands))
            {
                isValid = false;
            }
        ...
        public static MixedRealityPose ToMixedRealityPose(this OVRPlugin.Posef pose, bool adjustForEyeHeight = false)
        {
            return new MixedRealityPose
            (
                position: new Vector3(pose.Position.x,
                                      adjustForEyeHeight ? pose.Position.y + OVRPlugin.eyeHeight : pose.Position.y,
                                      -pose.Position.z),
        ...
        public static Vector3 GetPosePosition(this OVRPlugin.Posef pose)
        {
